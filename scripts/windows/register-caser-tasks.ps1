...
$scanCommand = "wsl.exe -d $WslDistro -- bash -lc '/home/sm/caser-search/scripts/run-scheduled-scan.sh'"
...
try {
    ...
    $schtasksCommand = "powershell.exe -NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -Command `"wsl.exe -d $WslDistro -- bash -lc '/home/sm/caser-search/scripts/run-scheduled-scan.sh'`""
